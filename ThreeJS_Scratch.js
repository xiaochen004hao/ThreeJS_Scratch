    ...
    constructor(runtime) {
        ...
        this._formatMessage = runtime.getFormatMessage({
            "zh-cn": {
                ...
                "ThreeJS_Scratch.setAmbientLightColor": "设置环境光颜色: [color]",
            ...
            en: {
                ...
                "ThreeJS_Scratch.setAmbientLightColor": "set AmbientLight\'s color: [color]",
        ...
        return {
            ...
            blocks: [  // 放积木：
                ...
                },
                {
                    ...
                    blockType: "command",
                    text: this.formatMessage("ThreeJS_Scratch.setAmbientLightColor"),
                    arguments: {
                        color: {
                            type: "number",
                        },
